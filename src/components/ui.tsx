...
import { ArrowRight, Clock3, Minus, Plus, ShoppingBag } from 'lucide-react';
...
export function Preparation({ compact = false }: { compact?: boolean }) { return <div className="preparation"><Clock3 size={20} aria-hidden="true" /><p>{compact ? `Hecho para esperar un poquito. Hasta ${business.preparationDays} días hábiles después de confirmar tu pedido.` : business.preparation}</p></div>; }
